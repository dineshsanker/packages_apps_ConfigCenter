...
package org.cesium.config.center.preferences;
...
public class FODIconPicker extends LayoutPreference {
    ...
    private static ImageButton ButttonOne;
    private static ImageButton ButttonTwo;
    private static ImageButton ButttonThree;
    ...
    private void setView(View view, Context context) {
        ...
        ButttonOne = findViewById(R.id.fodiconone_button);
        ButttonTwo = findViewById(R.id.fodicontwo_button);
        ButttonThree = findViewById(R.id.fodiconthree_button);

        int defaultfodicon = Settings.System.getInt(
                context.getContentResolver(), Settings.System.FOD_ICON, 0);
        if (defaultfodicon==0) {
            updateHighlightedItem(ButttonOne, context);
        } else if (defaultfodicon==1) {
            updateHighlightedItem(ButttonTwo, context);
        } else if (defaultfodicon==2) {
            updateHighlightedItem(ButttonThree, context);
        }

        ButttonOne.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ButttonTwo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        ButttonThree.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void updateHighlightedItem(ImageButton activebutton, Context context) {
        ...
        ButttonOne.setBackgroundTintList(defaulttint);
        ButttonTwo.setBackgroundTintList(defaulttint);
        ButttonThree.setBackgroundTintList(defaulttint);
